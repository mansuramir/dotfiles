...
--awful.util.tagnames = {  "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒", "➓" }
awful.util.tagnames = { '\u{31}', '\u{32}', '\u{33}', '\u{34}', '\u{35}' , '\u{36}' }   
--{ '\u{f268}', '\u{f121}', '\u{f120}', '\u{f015}', " " } -- eb23
--awful.util.tagnames = { "⠐", "⠡", "⠲", "⠵", "⠻", "⠿" }
...
local myawesomemenu = {
    ...
    { "edit config", terminal .. ' -e hx /home/mansur/.config/awesome/rc.lua' },
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F2", function () awful.util.spawn ( "alacritty -e hx") end,
        {description = "helix" , group = "function keys"}),
    awful.key({ modkey }, "F3", function () awful.util.spawn( "nitrogen" ) end,
        {description = "nitrogen" ,group = "function keys" }),
    awful.key({ modkey }, "F4", function () awful.util.spawn( "kate" ) end,
        {description = "kate" , group = "function keys" }),
    awful.key({ modkey }, "F5", function () awful.util.spawn( "geany" ) end,
        {description = "geany" , group = "function keys" }),
    ...
    awful.key({ modkey }, "F10", function () awful.util.spawn( "kitty -T 'Spotify TUI' -e ncspot" ) end,
        {description = "ncspot" , group = "function keys" }),
    ...
    awful.key({ modkey }, "u", function () awful.screen.focused().mypromptbox:run() end,
  	...
  	--awful.key({ modkey }, "x",  function () awful.util.spawn( "oblogout" ) end,
		awful.key({ modkey }, "x", function ()
																...
																end,-- get the client under the pointer
    ...
    awful.key({ modkey1, altkey   }, "p", function() awful.util.spawn( "telegram-desktop" ) end,
        {description = "Telegram Desktop", group = "alt+ctrl"}),
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot 'OpenBSD-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
    ...
    awful.key({ modkey1,  altkey        }, "Delete",      
		function() logout_popup.launch {
			...
			bg_color = "#3B4252", accent_color = "#ff4365", text_color = '#D8DEE9', -- nord
		}
		end,
 ...
 -- Show/Hide Systray       
    ...
    awful.key({ modkey1, "Shift" }, "m",
        function ()
            ...
            --beautiful.volume.update()
						volume_widget:volume_max()
        end),
    awful.key({ modkey1, "Shift" }, "0",
        function ()
            --os.execute(string.format("amixer -q set %s 0%%", beautiful.volume.channel))
            --beautiful.volume.update()
						volume_widget:volume_zero()
        end),

		awful.key({ modkey1, "Shift" }, "5",
        function ()
            --os.execute(string.format("amixer -q set %s 0%%", beautiful.volume.channel))
            --beautiful.volume.update()
						volume_widget:volume_half()
        end),
...
--awful.spawn("compton --config /home/mansur/.config/awesome/compton.conf")
awful.spawn("picom -b")
