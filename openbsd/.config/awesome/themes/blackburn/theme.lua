...
-- awful.util.tagnames   = { "\u{F0AC}", "\u{F3EB}"  , "\u{F120}", "\u{F2B6}", "\u{F240}"}
awful.util.tagnames   = { "\u{F0AC}", "\u{F120}"  , "\u{F3EB}", "\u{F108}", "\u{F240}"}
...
local bat = lain.widget.bat({
    settings = function()
        ...
        bat_p      = bat_now.perc .. " "
        bat_font = "Icons 10"
        widget:set_markup(markup.font(bat_font, markup(gray, bat_header) .. bat_p))
    end
})
...
theme.volume = lain.widget.alsa({
    ...
    settings = function()
        ...
        --vol_font = theme.font
        vol_font = "FontAwesome 10"
        widget:set_markup(markup.font(vol_font, markup(gray, header) .. vlevel))
    end
})
