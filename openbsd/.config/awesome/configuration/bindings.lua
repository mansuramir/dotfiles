...
require("configuration.preference")
require("awful.hotkeys_popup.keys")
local hotkeys_popup = require("awful.hotkeys_popup").widget


-- {{{ Mouse bindings
local msa_mousebindings = my_table.join(
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F7", function () awful.util.spawn( "nitrogen" ) end,
        {description = "nitrogen wallpaper chooser" , group = "function keys" }),
...
-- Set keys
root.buttons(msa_mousebindings)
