...
-- Font config
theme.font = "CaskaydiaCove Nerd Font " .. dpi(13) --10
theme.taglist_font = "CaskaydiaCove Nerd Font " .. dpi(15) --13
--theme.icon_font = "CaskaydiaCove Nerd Font"
theme.icon_font = "CaskaydiaCove Nerd Font"
theme.icon_font = "Font Awesome 6 Free"
theme.icon_size = dpi(14) --13
-- Menu
...
local function make_icon(icon_code, icon_color)
  local icon_widget = wibox.widget {
    ...
    --font = "Font Awesome 6 Brands Regular" .. ' ' .. theme.icon_size,
    align = 'center',
    valign = 'center',
...
local mytextclock = wibox.widget.textclock(markup(theme.fg_normal, "%d %b ") .. markup(theme.fg_normal, "%-I:%M%p"))
...
-- MSA's widgets
local temp_widget = require("msa-widgets.temp")

local islamicon = make_icon('\u{f678} ', theme.color.green)
local jakim_widget = require("msa-widgets.jakim-widget")
local capslock_widget = require("msa-widgets.capslock")
capslock_widget.font = "CaskaydiaCove Nerd Font bold 12"
--capslock_widget.activated = "<u>CAPS</u>"
--capslock_widget.deactivated = "<b> caps </b"

function theme.at_screen_connect(s)
  -- Tags
  --local names = { '\u{f268}', '\u{f121}', '\u{f120}', '\u{eb23}', '\u{f001}'} --'\u{fc58}'
  --local names = { '\u{f0ac}', '\u{f015}', '\u{f120}', '\u{eb23}', '\u{f001}'} --'\u{fc58}'
  local names = { '\u{f268}', '\u{f121}', '\u{f120}', '\u{eb23}', '\u{f001}'} --'\u{fc58}'
  local l = awful.layout.suit
    local layouts = { l.tile, l.max } -- l.floating }
  ...
  -- Create a tasklist widget - MSA
  local msa_tasklist = awful.widget.tasklist {
    screen = s,
