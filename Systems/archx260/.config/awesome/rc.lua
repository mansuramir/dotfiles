...
local myawesomemenu = {
  ...
  --{ "Edit config", function() awful.spawn.with_shell("lvim -e " .. awesome.conffile) end },
...
-- Toggle title bar
  ...
  require("msa-widgets.capslock").key,
  ...
  awful.key({ "Control", altkey }, "Delete",
    ...
    -- bg_color = "#282a36", accent_color = "#ff79c6", phrases = {}, -- dracula, no phrase
        ...
        bg_color = "#3B4252", accent_color = "#ff4365", text_color = '#D8DEE9', phrases={"Quit Awesome"},-- nord
...
--[[
  awful.key({ "Control", altkey }, "Delete",
    ...
    {
      description = "logout / reboot / shutdown / restart",
      group = "awesome"
    }
  ), --]]
  ...
  awful.key({ modkey }, "F2", function() awful.util.spawn(browser2) end,
    { description = browser2, group = "function keys" }),
  awful.key({ modkey }, "F3", function() awful.util.spawn(editorgui) end,
    { description = editorgui, group = "function keys" }),
  awful.key({ modkey }, "F4", function() awful.util.spawn(mediaplayer) end,
    { description = mediaplayer, group = "function keys" }),
  awful.key({ modkey }, "F5", function() awful.util.spawn("netflix") end,
    { description = "Netflix", group = "function keys" }),
  awful.key({ modkey }, "F6", function() awful.util.spawn("popcorntime") end,
    { description = "Popcorntime", group = "function keys" }),
  awful.key({ modkey }, "F7", function() awful.util.spawn(filemanager) end,
    { description = filemanager, group = "function keys" }),
  awful.key({ modkey }, "F8", function() awful.util.spawn(browser3) end,
    { description = "Brave Browser", group = "function keys" }),
  awful.key({ modkey }, "F9", function() awful.util.spawn("alacritty") end,
    { description = "alacritty", group = "function keys" }),
  awful.key({ modkey }, "F10", function() awful.util.spawn("kitty -e spotify_player") end,
    { description = "Spotify tui player", group = "function keys" }),
  awful.key({ modkey }, "F11", function() awful.util.spawn("kitty -e cava") end,
    { description = "Cava visualiser", group = "function keys" }),
  awful.key({ modkey }, "F12", function() awful.util.spawn("krusader") end,
    { description = "Krusader file manager", group = "function keys" }),

  -- rofi
  awful.key({ modkey }, "r",
    function()
      os.execute("rofi -show combi -combi-modi drun,run -show-icons")
    end,
    {
...
--awful.spawn.single_instance("setxkbmap -layout gb")
--awful.spawn("xinput set-prop 9 309 1")
awful.spawn.with_shell("/home/mansur/.local/bin/naturalscrolling.sh")
awful.spawn("nitrogen --restore")
