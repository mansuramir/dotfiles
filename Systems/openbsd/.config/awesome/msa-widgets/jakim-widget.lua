...
local function worker(args)
    ...
    local function prayertime_update()
        ...
        prayertime_text:set_markup(markup(color, mosque .. " " .. next_prayer))
	...
	if string.sub(today,1,1) == '0' then today = string.sub(today,2,11) end
        local msg = " Solat Time : "      .. today   .."\n" ..
		    ...
		    " Subuh\t    :    "   .. subuh    .. "\n" ..
                    ...
                    " Maghrib     :    "   .. maghrib  .. "\n" ..
                    " Isyak\t    :    "   .. isyak
        --return markup.fontfg(font, color, msg)
	return msg
    end
