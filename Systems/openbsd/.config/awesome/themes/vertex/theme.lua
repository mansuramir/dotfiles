...
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", "%a %-d %b, %-I:%M %P"))
...
theme.weather = lain.widget.weather({
    city_id = 1732903, -- placeholder (London)
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(18), bg = gears.color.create_png_pattern(theme.panelbg) })
